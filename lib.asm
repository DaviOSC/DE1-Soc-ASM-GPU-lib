...
send_instruction: 
	...
	push	{r4, lr}
	ldr r4, =pDevMem
	ldr	r4, [r4]                    @ r2 = valor de pWrFull(um endereco)
while_send_instruction:
	ldr	r2, [r4, #0xb0]                    @ r2 = valor indicado pelo endereco
	cmp	r2, #0                      @ if (*pWrFull == 0)
	bne	while_send_instruction      @ while (1)


	ldr	r2, [r4, #0xc0]                    @ r2 = pWrReg
	mov	r3, #0
	str	r3, [r2]                    @ *pWrReg = 0

	ldr	r3, [r4, #0x80]                    @ r3 = pDataA
	str	r0, [r3]                    @ *pDataA = dataA

	ldr	r3, [r4, #0x70]                    @ r3 = pDataB
